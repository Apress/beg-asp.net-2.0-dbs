...
<body>
    ...
    <div>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
            ...
            SelectCommand="SELECT ManufacturerID, ManufacturerName, ManufacturerCountry, ManufacturerEmail, ManufacturerWebsite FROM Manufacturer WHERE (ManufacturerID = @ManufacturerID)"
            UpdateCommand="UPDATE Manufacturer SET ManufacturerName = @ManufacturerName, ManufacturerCountry = @ManufacturerCountry, ManufacturerEmail = @ManufacturerEmail, ManufacturerWebsite = @ManufacturerWebsite WHERE ManufacturerID = @original_ManufacturerID AND ManufacturerName = @original_ManufacturerName AND ManufacturerCountry = @original_ManufacturerCountry AND ManufacturerEmail = @original_ManufacturerEmail AND ManufacturerWebsite = @original_ManufacturerWebsite"
            DeleteCommand="DELETE FROM Manufacturer WHERE ManufacturerID = @original_ManufacturerID AND ManufacturerName = @original_ManufacturerName AND ManufacturerCountry = @original_ManufacturerCountry AND ManufacturerEmail = @original_ManufacturerEmail AND ManufacturerWebsite = @original_ManufacturerWebsite"
            InsertCommand="INSERT INTO Manufacturer (ManufacturerName, ManufacturerCountry, ManufacturerEmail, ManufacturerWebsite) VALUES (@ManufacturerName, @ManufacturerCountry, @ManufacturerEmail, @ManufacturerWebsite)">
            <DeleteParameters>
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="ManufacturerID" DataSourceID="SqlDataSource1" Height="50px" Width="125px" OnItemUpdated="DetailsView1_ItemUpdated" OnItemCommand="DetailsView1_ItemCommand" OnDataBound="DetailsView1_DataBound">
            <Fields>
