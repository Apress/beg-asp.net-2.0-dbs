...
<script runat="server">
    ...
    private int SavePlayer(OleDbConnection myConnection, OleDbTransaction myTransaction)
    {
        // create the INSERT query
        string strQuery1 = "INSERT INTO Player (PlayerName, PlayerManufacturerID, PlayerCost, PlayerStorage) VALUES (?, ?, ?, ?);";
        OleDbCommand myCommand1 = new OleDbCommand(strQuery1, myConnection, myTransaction);
        ...
        OleDbCommand myCommand2 = new OleDbCommand(strQuery2, myConnection, myTransaction);
    ...
    private void SaveFormats(int intPlayerID, OleDbConnection myConnection, OleDbTransaction myTransaction)
    {
        // query to execute
        string strQuery = "INSERT INTO WhatPlaysWhatFormat (WPWFPlayerID, WPWFFormatID) VALUES (?, ?)";

        // create the command object
        OleDbCommand myCommand = new OleDbCommand(strQuery, myConnection, myTransaction);
