...
<body>
    ...
    <div>
        ...
        <table>
            <tr>
                <td valign="top">
                    <asp:DropDownList ID="lstManufacturers" runat="server" DataTextField="ManufacturerName" DataValueField="ManufacturerID" AutoPostBack="True" DataSourceID="SqlDataSource1" OnDataBound="lstManufacturers_DataBound"></asp:DropDownList>
                </td>
                <td valign="top">
