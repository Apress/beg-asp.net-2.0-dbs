...
<script runat="server">
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (gotResult)
        {
            ...
            OdbcDataSource2.SelectCommand = Query.ToString();
        }
        else
        {
            // clear the GridView
            OdbcDataSource2.SelectCommand = null;
        }
    }
...
<body>
    ...
    <div>
    <asp:SqlDataSource ID="OdbcDataSource1" runat="server"
    ...
    <asp:SqlDataSource ID="OdbcDataSource2" runat="server"
      ConnectionString="<%$ ConnectionStrings:OdbcConnectionString %>"
      ProviderName="<%$ ConnectionStrings:OdbcConnectionString.ProviderName %>">
    </asp:SqlDataSource>
    <table>
        <tr>
            <td valign="top">
                <asp:ListBox ID="ListBox1" runat="server" SelectionMode="Multiple" DataTextField="ManufacturerName" DataValueField="ManufacturerID" DataSourceID="OdbcDataSource1"></asp:ListBox>
                <br />
                <asp:Button ID="Button1" runat="server" Text="Select" OnClick="Button1_Click" />
            </td>
            <td valign="top">
                <asp:GridView ID="GridView1" runat="server" DataSourceID="OdbcDataSource2">
                </asp:GridView>
            </td>
        </tr>
    </table>
