...
<body>
    ...
    <div>
        ...
        <table>
            <tr>
                <td valign="top">
                    <asp:DropDownList ID="lstManufacturers" runat="server" DataTextField="ManufacturerName" DataValueField="ManufacturerID" AutoPostBack="True" DataSourceID="OdbcDataSource1" OnDataBound="lstManufacturers_DataBound"></asp:DropDownList>
                </td>
                <td valign="top">
                    <asp:GridView ID="GridView1" runat="server" DataSourceID="OdbcDataSource2"></asp:GridView>
                </td>
            </tr>
        </table>
    </div>
