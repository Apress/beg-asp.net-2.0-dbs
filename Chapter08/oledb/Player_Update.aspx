...
<script runat="server">
    ...
    private bool SaveFormats()
    {
        ...
        try
        {
            ...
            string strQuery2 = "INSERT INTO WhatPlaysWhatFormat (WPWFPlayerID, WPWFFormatID) VALUES (@PlayerID, @FormatID)";
            ...
            myCommand2.Parameters.Add("@FormatID", System.Data.OleDb.OleDbType.Integer);
