...
DROP TABLE IF EXISTS WhatPlaysWhatFormat;
DROP TABLE IF EXISTS Format;
DROP TABLE IF EXISTS Player;
DROP TABLE IF EXISTS Manufacturer;

CREATE TABLE Manufacturer (
  ManufacturerID integer unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE Player (
  ...
  PlayerManufacturerID integer unsigned NOT NULL default "0",
...
CREATE TABLE WhatPlaysWhatFormat (
  WPWFPlayerID integer unsigned NOT NULL default "0",
  WPWFFormatID integer unsigned NOT NULL default "0",
