...
<script runat="server">
    ...
    void GenerateDataSet(DataSet dset, OdbcConnection conn)
    {
        // add four tables
        AddPlayerTable(dset);
    ...
    void FillManufacturerTable(DataSet dset, OdbcConnection conn)
    {
        ...
        OdbcDataAdapter ManufacturerAdapter = new OdbcDataAdapter();
        OdbcCommand ManufacturerCommand = new OdbcCommand("SELECT * FROM Manufacturer ORDER BY ManufacturerID", conn);
    ...
    void FillPlayerTable(DataSet dset, OdbcConnection conn)
    {
        // create the Command and DataAdapter  
        OdbcDataAdapter PlayerAdapter = new OdbcDataAdapter();
        OdbcCommand PlayerCommand = new OdbcCommand("SELECT * FROM Player ORDER BY PlayerID", conn);
    ...
    void FillFormatTable(DataSet dset, OdbcConnection conn)
    {
        // create the Command and DataAdapter  
        OdbcDataAdapter FormatAdapter = new OdbcDataAdapter();
        OdbcCommand FormatCommand = new OdbcCommand("SELECT * FROM Format ORDER BY FormatID", conn);
    ...
    void FillWhatPlaysWhatFormatTable(DataSet dset, OdbcConnection conn)
    {
        // create the Command and DataAdapter  
        OdbcDataAdapter WhatPlaysWhatFormatAdapter = new OdbcDataAdapter();
        OdbcCommand WhatPlaysWhatFormatCommand = new OdbcCommand("SELECT * FROM WhatPlaysWhatFormat", conn);
