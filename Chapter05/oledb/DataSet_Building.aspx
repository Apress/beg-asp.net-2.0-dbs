...
<script runat="server">
    ...
    void GenerateDataSet(DataSet dset, OleDbConnection conn)
    {
        // add four tables
        AddPlayerTable(dset);
    ...
    void FillManufacturerTable(DataSet dset, OleDbConnection conn)
    {
        ...
        OleDbDataAdapter ManufacturerAdapter = new OleDbDataAdapter();
        OleDbCommand ManufacturerCommand = new OleDbCommand("SELECT * FROM Manufacturer ORDER BY ManufacturerID", conn);
    ...
    void FillPlayerTable(DataSet dset, OleDbConnection conn)
    {
        // create the Command and DataAdapter  
        OleDbDataAdapter PlayerAdapter = new OleDbDataAdapter();
        OleDbCommand PlayerCommand = new OleDbCommand("SELECT * FROM Player ORDER BY PlayerID", conn);
    ...
    void FillFormatTable(DataSet dset, OleDbConnection conn)
    {
        // create the Command and DataAdapter  
        OleDbDataAdapter FormatAdapter = new OleDbDataAdapter();
        OleDbCommand FormatCommand = new OleDbCommand("SELECT * FROM Format ORDER BY FormatID", conn);
    ...
    void FillWhatPlaysWhatFormatTable(DataSet dset, OleDbConnection conn)
    {
        // create the Command and DataAdapter  
        OleDbDataAdapter WhatPlaysWhatFormatAdapter = new OleDbDataAdapter();
        OleDbCommand WhatPlaysWhatFormatCommand = new OleDbCommand("SELECT * FROM WhatPlaysWhatFormat", conn);
