...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:OdbcConnectionString %>" ProviderName="<%$ ConnectionStrings:OdbcConnectionString.ProviderName %>" SelectCommand="SELECT ManufacturerID, ManufacturerName FROM Manufacturer ORDER BY ManufacturerName">
        </asp:SqlDataSource>
                        ...
                        <InsertItemTemplate>
                            <table bgcolor="LightGreen">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="litPlayerName" runat="server" Text='<%# Bind("PlayerName") %>'></asp:TextBox>
                                    </td>
                                </tr>  
                               <tr>
                                    <td>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="litPlayerCost" runat="server" Text='<%# Bind("PlayerCost") %>'></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="litPlayerStorage" runat="server" Text='<%# Bind("PlayerStorage") %>'></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                            <asp:LinkButton ID="btnInsert" runat="server" CommandName="Insert" Text="Insert" /> <asp:LinkButton ID="btnCancel" runat="server" CommandName="Cancel" Text="Cancel" />
                        </InsertItemTemplate>
                        <EditItemTemplate>
                            ...
                            <asp:LinkButton ID="btnUpdate" runat="server" CommandName="Update" Text="Update" /> <asp:LinkButton ID="btnCancel" runat="server" CommandName="Cancel" Text="Cancel" />
                        </EditItemTemplate>                                               
                    </asp:FormView>
                </td>
            </tr>
