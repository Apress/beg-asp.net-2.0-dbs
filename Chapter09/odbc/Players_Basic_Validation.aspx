...
<body>
    ...
    <div>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OdbcConnectionString %>" ProviderName="<%$ ConnectionStrings:OdbcConnectionString.ProviderName %>" DeleteCommand="DELETE FROM Player WHERE PlayerID = ?" InsertCommand="INSERT INTO Player (PlayerName, PlayerManufacturerID, PlayerStorage, PlayerCost) VALUES (?, ?, ?, ?)" SelectCommand="SELECT PlayerID, PlayerName, ManufacturerName, PlayerManufacturerID, PlayerStorage, PlayerCost FROM Player INNER JOIN Manufacturer ON Player.PlayerManufacturerID = Manufacturer.ManufacturerID" UpdateCommand="UPDATE Player SET PlayerName = ?, PlayerManufacturerID = ?, PlayerStorage = ?, PlayerCost = ? WHERE PlayerID = ?">
            <DeleteParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:OdbcConnectionString %>" ProviderName="<%$ ConnectionStrings:OdbcConnectionString.ProviderName %>" SelectCommand="SELECT ManufacturerID, ManufacturerName FROM Manufacturer ORDER BY ManufacturerName">
        </asp:SqlDataSource>
