...
<script runat="server">
    ...
    protected void DetailsView1_ItemDeleting(object sender, DetailsViewDeleteEventArgs e)
    {
        ...
        {
            // query to execute
            string strQuery = "SELECT COUNT(*) FROM WhatPlaysWhatFormat WHERE WPWFFormatID = @FormatID";
...
<body>
    ...
    <div>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SqlConnectionString %>" SelectCommand="SELECT [FormatID], [FormatName] FROM [Format] ORDER BY FormatName">
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SqlConnectionString %>" DeleteCommand="DELETE FROM [Format] WHERE [FormatID] = @FormatID" InsertCommand="INSERT INTO [Format] ([FormatName]) VALUES (@FormatName)" SelectCommand="SELECT [FormatID], [FormatName] FROM [Format] WHERE ([FormatID] = @FormatID)" UpdateCommand="UPDATE [Format] SET [FormatName] = @FormatName WHERE [FormatID] = @FormatID">
            <DeleteParameters>
